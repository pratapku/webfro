...
from .models import Message ,allDevices
...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    def save_message(self, d_id, sensor1,sensor2):
        ...
        if Message.objects.filter(d_id=d_id).exists:
            ...
            Message.objects.create(d_id=d_id, sensor1=sensor1,sensor2=sensor2)
            print("created...!!!")
